 ...
 * - We don't want the careTaker entity to have access to SetState or modity any data. We just give the necessary methods to access of TextEditor 
 * to careTaker acheiving encapsulation.
 *
 * 
